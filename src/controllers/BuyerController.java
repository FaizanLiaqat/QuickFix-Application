...
public class BuyerController {
	...
	@FXML private Button view_profile;
	@FXML private Button book_service;
	@FXML private Button payment_history;
	@FXML private Button exit;
	private String currenttype = "buyer";
	...
	public void openBookServiceButtonOnAction(ActionEvent event) {
		try {	        
			// Close the current window (home.fxml)
			Stage currentStage = (Stage) exit.getScene().getWindow();
			currentStage.close();
			...
			// Load the Access.fxml file
			Parent root = FXMLLoader.load(getClass().getResource("/views/book_service.fxml"));
