...
/**
 * Represents a dispute between a buyer and a seller related to a booking. The
 * dispute can have various statuses like "Open", "Resolved", or "Rejected".
 */
public class Dispute {
	...
	public Dispute(int disputeID, int bookingID, int buyerID, int sellerID, String disputeReason, String disputeStatus,
	...
	/**
	 * Overrides the toString method to provide a readable format of the dispute
	 * details.
	 * 
	...
	public String toString() {
		return "Dispute{" + "disputeID=" + disputeID + ", bookingID=" + bookingID + ", buyerID=" + buyerID
				+ ", sellerID=" + sellerID + ", disputeReason='" + disputeReason + '\'' + ", disputeStatus='"
				+ disputeStatus + '\'' + ", resolutionDetails='" + resolutionDetails + '\'' + ", createdAt=" + createdAt
